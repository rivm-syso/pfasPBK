...
TSTART <- 0
TSTOP <- 5 # days
exposure_duration = 20 # Duration of exposure (d)
DT <- 1/24
TIME <- seq(TSTART,TSTOP,by=DT)

Oralexpo_PFOA = 0 # 0.000187 # µg/kg/day [EFSA opinion 2020, p.144] # 0.00015 = TWI of 4.4 ng/kg/wk assuming PFOA:PFOS ratio of 24:76 from [EFSA opinion 2020, p.152]
Oralexpo_PFOS = 0 # 0.000444 # µg/kg/day [EFSA opinion 2020, p.144] # 0.000458 = TWI of 4.4 ng/kg/wk assuming PFOA:PFOS ratio of 24:76 from [EFSA opinion 2020, p.152]
...
A_init_PFAS_extended <- c(Alun_PFOA = 0, # ALunbirth_PFOA,
                          ...
                          AL_PFOA = 100, # ALbirth_PFOA, # Initial amount in liver (ug)
                          ...
                          AL_PFOS = 100, # ALbirth_PFOS, # Initial amount in liver (ug)
...
write.table(output.df, file = "validation/results/results_R_PFAS_no_dosing.csv", dec = ".", sep = ",", row.names = FALSE, na = "")
